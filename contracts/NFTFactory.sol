...
contract NFTFactory is Initializable, ContextUpgradeable, AccessControlEnumerableUpgradeable, ERC1155BurnableUpgradeable, ERC1155PausableUpgradeable {
     ...
     */
    function __ERC1155Minter_init(string memory uri) internal initializer {
        __Context_init_unchained();
        __ERC165_init_unchained();
        __AccessControl_init_unchained();
        __AccessControlEnumerable_init_unchained();
        __ERC1155_init_unchained(uri);
        __ERC1155Minter_init_unchained(uri);
    }

    function __ERC1155Minter_init_unchained(string memory uri) internal initializer {
